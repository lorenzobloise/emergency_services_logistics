(define (problem emergency_services_logistics_problem_3)
    ...
    (:init
        ...
        (needsContent p7 food)
        (needsContent p7 medicine)
        (needsContent p7 tools)
        (needsContent p8 food)
        (needsContent p8 medicine)
        (needsContent p8 tools)
    ...
    (:goal (and
        ...
        (isSatisfied p7 food)
        (isSatisfied p7 medicine)
        (isSatisfied p7 tools)
        (isSatisfied p8 food)
        (isSatisfied p8 medicine)
        (isSatisfied p8 tools)
    ))
